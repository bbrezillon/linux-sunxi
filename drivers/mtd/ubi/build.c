...
static struct device_attribute dev_version =
	__ATTR(version, S_IRUGO, dev_attribute_show, NULL);
...
static int io_init(struct ubi_device *ubi, int max_beb_per1024)
{
	...
	ubi->max_lebs_per_peb = mtd_pairing_groups(ubi->mtd);
