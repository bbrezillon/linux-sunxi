...
#define UBI_JNL_VOLUME_ID		(UBI_LAYOUT_VOLUME_ID + 3)

#define UBI_JNL_MAGIC			0x55424950

enum ubi_jnl_node_type {
	UBI_JNL_SUMMARY_NODE,
	UBI_JNL_LAYOUT_NODE,
	UBI_JNL_PEB_EC_SUMMARY_NODE,
	UBI_JNL_PEB_STATUS_SUMMARY_NODE,
	UBI_JNL_VOL_SUMMARY_NODE,
	UBI_JNL_VOL_NODE,
	UBI_JNL_EBA_PNUM_NODE,
	UBI_JNL_EBA_LPOS_NODE,
	UBI_JNL_UPDATE_NODE,
	UBI_JNL_MOVE_NODE,
	UBI_JNL_PEB_NODE,
	UBI_JNL_LEB_NODE,
	UBI_JNL_REFILL_PEB_POOL_NODE,
};

enum ubi_jnl_peb_op_type {
	UBI_JNL_ERASE_PEB,
	UBI_JNL_SCRUB_PEB,
	UBI_JNL_MARK_PEB_BAD,
};

#define UBI_JNL_TORTURE_PEB_FLG		BIT(0)

struct ubi_jnl_peb_node {
	__u8 type;
	__u8 op;
	__u8 flags;
	__u8 padding1[1];
...
enum ubi_jnl_leb_op_type {
	UBI_JNL_UNMAP_LEB,
	UBI_JNL_MAP_OR_UPD_LEB,
};

struct ubi_jnl_leb_node {
	__u8 type;
	__u8 op;
	__u8 lpos;
	__u8 padding1[1];
...
struct ubi_jnl_refill_peb_pool_node {
	__u8 type;
	__u8 padding[3];
	__be32 pnum;
};

struct ubi_jnl_update_node {
	__be32 magic;
	__u8 type;
	__u8 padding1[3];
	__be32 data_size;
...
struct ubi_jnl_move_node {
	__u8 type;
	__u8 padding1[3];
	__be32 pnum;
};

struct ubi_jnl_eba_lpos_node {
	__u8 type;
	__u8 padding[7];
	__u8 lpos[0];
};

struct ubi_jnl_eba_pnum_node {
	__u8 type;
	__u8 padding[7];
	__be32 pnums[0];
};

struct ubi_jnl_vol_node {
	__u8 type;
	__u8 vol_type;
	__u8 vol_mode;
	__u8 padding1[1];
...
struct ubi_jnl_vol_summary_node {
	__u8 type;
	__u8 padding1[3];
	__be32 nvols;
};

enum ubi_jnl_peb_status {
	UBI_JNL_PEB_STATUS_UNKNOWN,
	UBI_JNL_PEB_STATUS_FREE,
	UBI_JNL_PEB_STATUS_USED,
	UBI_JNL_PEB_STATUS_PROTECTED,
	UBI_JNL_PEB_STATUS_SCRUBING,
	UBI_JNL_PEB_STATUS_ERASING,
};

struct ubi_jnl_peb_status_summary_node {
	__u8 type;
	__u8 status[0];
};

struct ubi_jnl_peb_ec_summary_node {
	__u8 type;
	__u8 padding1[3];
	__be32 ec[0];
};

#define UBI_JNL_MIN_PEB_POOL_SIZE	8
#define UBI_JNL_MAX_PEB_POOL_SIZE	256

struct ubi_jnl_peb_pool_node {
	__u8 type;
	__u8 padding1[3];
	__be32 npebs;
	__be32 pnums[0];
